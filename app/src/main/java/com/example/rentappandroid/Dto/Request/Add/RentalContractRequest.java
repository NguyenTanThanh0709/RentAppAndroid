...
public class RentalContractRequest {
    ...
    public RentalContractRequest(String tenant_phone, String password, String tenant, String landlord, String cccd_front, String cccd_back, String roomingHouse, String create_date, String start_date, String end_date, String billing_start_date, int rent_price, int deposit, int payment_term, List<String> image_url, boolean status, boolean is_paid) {
        this.tenant_phone = tenant_phone;
        this.password = password;
        this.tenant = tenant;
        this.landlord = landlord;
